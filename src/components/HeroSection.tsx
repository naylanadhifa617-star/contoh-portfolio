...
export default function HeroSection() {
  return (
    <section
      id="home"
      className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-blue-100 px-6 py-20"
    >
      <div className="flex flex-col md:flex-row items-center gap-12 max-w-6xl w-full">
        ...
        >
          ...
          <h1 className="text-4xl md:text-4xl font-bold leading-tight">
            ...
            <span className="block tracking-wide text-blue-500">
              ｐｏｒｔｏｆｏｌｉｏ
            </span>
          </h1>
